...
%---- Section ----%
\section{Following Joyal-Kock to remedy the object problem}
...
In this section, we define a category that plays the same role as $\el$ plays in the Joyal-Kock approach, discussed in \cref{***}.

\begin{definition}
Define the elementary category $\El$
\end{definition}
